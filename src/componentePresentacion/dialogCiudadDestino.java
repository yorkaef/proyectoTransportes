...
import componenteNegocio.CiudadDestinoCN;
...
public class dialogCiudadDestino extends javax.swing.JDialog {
    ...
    private void botGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botGuardarActionPerformed
        ...
        ciudadDestino.setCiudadDestinoid(txtCodigo.getText());
        ciudadDestino.setNombre(txtNombre.getText());
        ciudadDestino.setCodigoPostal(txtCodigoPostal.getText());
        ciudadDestino.setProvincia(cboProvincia.getSelectedItem().toString());
        try {
            int registros_afectados = CiudadDestinoCN.getInstancia().crearCiudad(ciudadDestino);
